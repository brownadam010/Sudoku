class Scene2 extends Phaser.Scene {
  ...
  //OnSquareClicked(pointer, gameObject) {
    /*if(Phaser.input.keyboard.isDown(Phaser.Keyboard.NUM_ONE)) {
      gameObject.value == '1';
    }*/
  //}
}